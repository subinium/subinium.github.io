...
물론 이 방법도 임시 방편이라는 것을 알아두세요. 이 문제에 대한 정답은 아직 없습니다.
...
비선형 모델은 선형 모델에 비해 유연하고, 매개변수도 따로 설정할 필요가 없습니다. 하지만 이런 장점과 데이터의 수는 트레이트오프 관계입니다. 유연하고, 매개변수를 따로 설정할 필요가 없는 대신 데이터의 수는 더 많이 필요합니다.
...
이런 방법은 알고리즘 개발자 분이 연구를 진행하고 출판하지 않았을 수도 있으며,
...
이 논문은 학습 곡선을 통해 데이터셋의 필요 크기를 계획하는 방법에 관한 논문입니다. 12년 논문이라 꽤나 이전 논문이지만, 이런 문제에 대한 논의를 하기에 좋은 논문인 것 같습니ㅏㄷ.
