...
- **[One-Shot Voice Conversion 보고서](https://subinium.github.io/Voice-Conversion/)**
  - 이걸 만들면서도 [몇 가지 이슈](/_posts/blog/2020-02-19-github-page-and-audio-issue.md)가 있었으나...
...
- task 1 : 영어 화자 4명 -> 영어 화자 4명, 총 16 pairs
  - 여자와 남자에 대한 고려가 필요, non-parallel한 dataset
...
대회 결과가 출중히 좋다고 이야기할 수는 없으나, 제 인턴 기간은 후회 한 점 없이 뿌듯하고 행복한 경험으로 남았습니다. 실력도 늘었고, 딥러닝 자신감도 한껏 챙겼습니다.
